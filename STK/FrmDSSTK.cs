...
namespace STK
{
    public partial class FrmDSSTK : Form
    {
        ...
        void KetNoiCSDLTatToan()
        {
            ...
            string sql1 = "SELECT t.ID , t.MaSo , t.SoTienGui ,t.KyHan,t.NgayGui, t.LaiSuat, n.TenNganHang, n.MaNganHang FROM TheTietKiem t, NganHang n Where Email = '" + lbnGetEmail.ToString() + 
        ...
        private void btnTatToan_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    string sql2 = "UPDATE TheTietKiem SET TatToan = 1 , TienLai ='" + tongLai + "' Where ID = '" + Key + "' ";
                    cnn.Open();
                    SqlCommand cmd = new SqlCommand(sql2, cnn);
                    cmd.ExecuteNonQuery();
                    cnn.Close();
